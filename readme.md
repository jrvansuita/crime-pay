...
##### This project is paused right now due the hard time crypto markets is crossing. Will be resumed at better time. But the demo is on.
...
- [x] Player Minter 
- [x] Login form load after page
- [x] Login placeholder while loading 
